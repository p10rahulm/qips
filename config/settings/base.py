...
LOCAL_APPS = [
    'qips.users.apps.UsersAppConfig',
...
ADMINS = [
    ("""Rahul Madhavan""", 'rahul.maddy@gmail.com'),
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'qips.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'qips.users.adapters.SocialAccountAdapter'
